...
public class OptionSelector extends ElementListSelectionDialog {
	...
	public OptionSelector(Shell parent, List<CLIOption> options) {
		...
		setMessage("Choose an option (? = any character, * = any string)");
	...
	private void createArgumentArea(Composite parent) {
		...
		new Label(container, SWT.NONE).setText("Arguments:");
		...
		new Label(container, SWT.NONE).setText("Option Description:");
	...
	protected void handleSelectionChanged() {
		...
		if (arguments != null) {
			fArgumentText.setText(String.join(" ", arguments));
